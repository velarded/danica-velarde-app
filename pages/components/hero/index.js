    ...
    <div className={styles.heroContainer}>
      <div className={styles.textContainer}>
        ...
        <p className={styles.textDescription}>
          I am a Software Developer in Toronto, Canada. I aspire to become a
          Full-Stack Developer and create websites which can be helpful to
          people in their everyday lives. During the COVID-19 pandemic, I
          decided to pick up React to start making ideas of mine become a
          reality.
          <br />
